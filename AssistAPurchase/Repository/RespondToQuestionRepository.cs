...
namespace AssistAPurchase.Repository
{
    public class RespondToQuestionRepository : MonitoringProductRepository, IRespondToQuestionRepository
    {
        ...
        {
            if (belowOrAbove == "ABOVE")
                return ProductConfigureSupporterFunctions.GetItemsAboveTheGivenScreenSize(screenSize, MonitoringItems);
            return ProductConfigureSupporterFunctions.GetItemsBelowTheGivenScreenSize(screenSize, MonitoringItems);
        }

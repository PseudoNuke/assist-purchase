...
namespace AssistAPurchase.Controllers
{
    ...
    public class RespondToQuestionsController : ControllerBase
    {
        ...
        public RespondToQuestionsController(IRespondToQuestionRepository products)
        {
            Products = products;
        }
        // POST https://localhost:5001/api/RespondToQuestions/MonitoringProduct
        ...
        // GET https://localhost:5001/api/RespondToQuestions/MonitoringProductHomePage/Compact/{value}
        ...
        // GET https://localhost:5001/api/RespondToQuestions/MonitoringProductHomePage/Description/{productNumber}
